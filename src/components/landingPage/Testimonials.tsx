...
import Default_Course_Image from "../../assets/landingPage/Default_Course_img.png";
...
const Testimonials = (): React.JSX.Element => {
  ...
  const doubled: TestimonialCard[] = [...cardsData, ...cardsData];

  const categories: string[] = ['Data Science', 'Cyber Security', 'Business', 'Accounting', 'Computer Science', 'Analytics'];

  return (
    <section className="py-24 bg-gray-50 px-6 overflow-hidden">
      <div className="container mb-24">
        <h2 className="text-4xl font-bold text-gray-900 leading-tight mb-8 text-center">What our <br/> valuable users say about us.</h2>
        ...
        <div className="flex flex-col gap-8">
            ...
            <div className="w-full mx-auto max-w-5xl overflow-hidden relative">
                ...
                <div className="marquee-inner flex transform-gpu min-w-[200%] pt-10 pb-5" id="row1">
                    {doubled.map((card, index) => (
                        <div key={`row1-${index}`} className="bg-white p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 border border-gray-100">
                            <div className="flex gap-2">
                                ...
                                <div className="flex flex-col">
                                    <div className="flex items-center gap-1">
                                        ...
                                        <svg className="mt-0.5 text-blue-500" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="text-sm py-4 text-gray-800 text-left leading-relaxed">Radiant made undercutting all of our competitors an absolute breeze.</p>
                            <div className="flex items-center justify-between text-slate-500 text-xs">
                                <div className="flex items-center gap-1">
                                    <span>Posted on</span>
                                    <a href="#" target="_blank" className="hover:text-blue-500 transition-colors">
            ...
            <div className="w-full mx-auto max-w-5xl overflow-hidden relative">
                ...
                <div className="marquee-inner marquee-reverse flex transform-gpu min-w-[200%] pt-5 pb-10" id="row2">
                    {doubled.map((card, index) => (
                        <div key={`row2-${index}`} className="bg-white p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 border border-gray-100">
                             <div className="flex gap-2">
                                <img className="size-11 rounded-full object-cover" src={card.image} alt="User Image" />
                                <div className="flex flex-col">
                                    <div className="flex items-center gap-1">
       ...
       <div className="container">
           <h3 className="text-2xl font-bold mb-8 text-gray-900 text-center lg:text-left">Explore EduNova Ai</h3>
           <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
               {categories.map((item, idx) => (
                   <div key={idx} className="bg-white p-6 rounded-2xl flex items-center gap-4 border border-gray-100 transition-all duration-300 hover:border-primary hover:-translate-y-1">
                       <div className="w-20 h-20 bg-gray-100 rounded-lg shrink-0 overflow-hidden">
                            <img src={Default_Course_Image} alt="Default Course Image" className="w-full h-full object-cover" />
                       </div>
                       <div>
                           <h4 className="text-base font-bold text-gray-900 mb-1 leading-tight">{item}</h4>
                           <span className="text-xs text-gray-500">120+ Courses</span>
                       </div>
                   </div>
               ))}
           </div>
